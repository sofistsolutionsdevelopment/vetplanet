...
GroomingProfileDetailsModel groomingProfileDetailsModelFromJson(String str) => GroomingProfileDetailsModel.fromJson(json.decode(str));

String groomingProfileDetailsModelToJson(GroomingProfileDetailsModel data) => json.encode(data.toJson());

class GroomingProfileDetailsModel {
  ...
  factory GroomingProfileDetailsModel.fromJson(Map<String, dynamic> json) => GroomingProfileDetailsModel(
