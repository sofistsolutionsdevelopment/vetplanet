...
class _CheckRazorState extends State<CheckRazor> {
  ...
  Future<ResultModel> saveAppointment() async{
    ...
    final String url = "$apiUrl/SaveAppointmentForGrooming/SaveAppointmentForGrooming";
  ...
  Future<ResultModel> deletePreServices() async{
    ...
    final String url =  "$apiUrl/DeletePreGroomingService/DeletePreGroomingService";
