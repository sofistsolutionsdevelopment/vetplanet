...
class CheckRazorVet extends StatefulWidget {
  final String amount;
  ...
  CheckRazorVet({ this.amount, this.transactionId, this.vetId, this.clinicId, this.token, this.checkServices, this.checkPet, this.slotId, this.slotDate, this.slotStart, this.slotEnd, this.dayId });
  @override
  _CheckRazorVetState createState() => _CheckRazorVetState();
}

class _CheckRazorVetState extends State<CheckRazorVet> {
  ...
  Future<ResultModel> updateTransaction(String paymentId, String patientSlotId) async{
    ...
    final String url = "$apiUrl/UpdateTransaction/UpdateTransaction";
  ...
  Future<ResultModel> updateTransactionStatus(String status) async{
    ...
    final String url = "$apiUrl/UpdateTransactionStatus/UpdateTransactionStatus";
