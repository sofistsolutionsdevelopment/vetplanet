...
class SelectPetForNextVaccDatePage extends StatefulWidget {
  final Function onPressed;
  final String vetId;
  final String from;

  SelectPetForNextVaccDatePage({ this.onPressed, this.vetId, this.from });
  @override
  _SelectPetForNextVaccDatePageState createState() => _SelectPetForNextVaccDatePageState();
}

class _SelectPetForNextVaccDatePageState extends State<SelectPetForNextVaccDatePage> {
                            ...
                            child: InkWell(
                              onTap: (){
                                ...
                                if(widget.from == "drawer"){
                                  Navigator.push(context, SlideLeftRoute(page: NextVaccinationDateFormDrawerPage(petId:patientPetId, vetId:vetId)));
                                }
                                if(widget.from == "vetDetails"){
                                  Navigator.push(context, SlideLeftRoute(page: NextVaccinationDatePage(petId:patientPetId, vetId:vetId)));
                                }
