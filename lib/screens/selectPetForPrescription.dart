...
class SelectPetForPrescriptionPage extends StatefulWidget {
  final Function onPressed;
  final String vetId;

  SelectPetForPrescriptionPage({ this.onPressed, this.vetId });
  @override
  _SelectPetForPrescriptionPageState createState() => _SelectPetForPrescriptionPageState();
}

class _SelectPetForPrescriptionPageState extends State<SelectPetForPrescriptionPage> {
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: (){
                                  ...
                                  print("vetId : $vetId");
                                Navigator.push(context, SlideLeftRoute(page: PrescriptionPage(petId:patientPetId, vetId:vetId,)));
