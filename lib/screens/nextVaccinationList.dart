...
class NextVaccinationDatePage extends StatefulWidget {
  final String petId;
  final String vetId;

  NextVaccinationDatePage({ this.petId, this.vetId });
  @override
  _NextVaccinationDatePageState createState() => _NextVaccinationDatePageState();
}

class _NextVaccinationDatePageState extends State<NextVaccinationDatePage> {
  void rebuildPage() {
    setState(() {});
  }
  ...
  Future<List<VaccinationModel>> getVaccination() async {
    ...
    final String url = "$apiUrl/GetVaccinationByVetId/GetVaccinationByVetId";
