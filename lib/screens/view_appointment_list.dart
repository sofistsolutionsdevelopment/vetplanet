...
class _ViewAppointmentPageState extends State<ViewAppointmentPage> {
  ...
  Future<ResultModel> cancelAppointment(String SlotId ) async{
    ...
    final String apiUrl =  "$_API_Path/CancelAppointment/CancelAppointment";
...
/*
  ...
  ViewAppointmentResultModel _viewappointmentresult;
  List data;

  String _dataLenght = "";

  Future<ViewAppointmentResultModel> getData() async{
    final _prefs = await SharedPreferences.getInstance();
    String _API_Path = _prefs.getString('API_Path');
    String _RegistrationId = _prefs.getInt('id').toString();
    ...
    final String apiUrl =  "$_API_Path/ViewAppointment/ViewAppointments";
    ...
    if(response.statusCode == 200){
      ...
      return viewappointmentresultModelFromJson(responseString);
    }else{
      debugPrint('Check Inserted 5 ');
      return null;
    }
            ...
            actions: <Widget>[
              TextButton(
                //  color: Colors.red,
                  child: Padding(
                    ...
                    child: Text('Yes',style: TextStyle(color: appColor,fontSize: 18,  fontFamily: "Camphor",
              ...
              TextButton(
               // color: Colors.green,
                child: Padding(
                  padding: const EdgeInsets.all(5.0),
                  child: Text('No',style: TextStyle(color: appColor,fontSize: 18, fontFamily: "Camphor",
                    fontWeight: FontWeight.w900,),),
                ),
                onPressed: () {
                  getData();
            ...
            if(_dataLenght == "0")
              Column(
                ...
                children: <Widget>[
                  SizedBox(height: 25,),
                  Center(
                    child: Text("No Appointment for Vet",textAlign: TextAlign.center, style: TextStyle(fontSize: 19, color: Colors.black,fontFamily: "Camphor",
