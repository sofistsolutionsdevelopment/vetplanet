...
class   ServicesDialog extends StatefulWidget {
  ...
  ServicesDialog({ this.groomingId, this.patientPetId, this.shopId, this.token });
  @override
  _AdmissionDateDialogState createState() => new _AdmissionDateDialogState();
}

class _AdmissionDateDialogState extends State<ServicesDialog> {
   ...
   return WillPopScope(
      onWillPop: () {
        ...
        Navigator.of(context)
            ...
            SelectPetForGroomingPage(onPressed: rebuildPage,
              groomingId: widget.groomingId,
              token: widget.token,
              shopId: widget.shopId,)));
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(context, SlideLeftRoute(
                    page: SelectPetForGroomingPage(shopId: widget.shopId,
                        groomingId: widget.groomingId,
                        token: widget.token)));
              },
            ),
