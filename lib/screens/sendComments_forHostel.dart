...
class SendCommentforHostelPage extends StatefulWidget {
  final String userKey;

  SendCommentforHostelPage({ this.userKey});
  @override
  _SendCommentforHostelPageState createState() => _SendCommentforHostelPageState();
}

class _SendCommentforHostelPageState extends State<SendCommentforHostelPage> {
  ...
  Future<ResultModel> saveComment(String comment) async{
    ...
    debugPrint('Check saveComment apiUrl $apiUrl ');
    debugPrint('Check saveComment _RegistrationId $_RegistrationId ');

    final String url = "$apiUrl/SaveHostelComment/SaveHostelComment";
    ...
    return WillPopScope(
      onWillPop: (){
        ...
        Navigator.of(context)
            .pushReplacement(new MaterialPageRoute(builder: (context) => HostelDetails(onPressed: rebuildPage, userKey:widget.userKey)));
                  ...
                  InkWell(
                    ...
                    if (_formStateKey.currentState.validate()) {
                      ...
                      Navigator.pushReplacement(
                          context, MaterialPageRoute(builder: (context) => AllCommentsHostelPage(userKey:widget.userKey)));
                    }
                  },
                    child: Container(
                      color: appColor,
