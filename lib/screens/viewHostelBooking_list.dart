...
import 'package:vetplanet/models/viewHostelBooking_model.dart';
import 'package:vetplanet/models/view_appointment_model.dart';
import 'dash.dart';
import 'drawer.dart';

class ViewHostelBookingPage extends StatefulWidget {

  @override
  _ViewHostelBookingPageState createState() => _ViewHostelBookingPageState();
}

class _ViewHostelBookingPageState extends State<ViewHostelBookingPage> {
  ...
  Future<ResultModel> cancelAppointment(String SlotId ) async{
    ...
    final String apiUrl =  "$_API_Path/CancelHostelBooking/CancelHostelBooking";
  ...
  Future<ViewHostelBookingResultModel> getData() async{
    final _prefs = await SharedPreferences.getInstance();
    String _API_Path = _prefs.getString('API_Path');
    String _RegistrationId = _prefs.getInt('id').toString();
    ...
    final String apiUrl =  "$_API_Path/ViewHostelBooking/ViewHostelBooking";
    ...
    if(response.statusCode == 200){
      ...
      return viewHostelBookingResultModelFromJson(responseString);
    }else{
      debugPrint('Check Inserted 5 ');
      return null;
    }
                                    ...
                                    if("${data[index]["Status"]}" == "Pending")
                                      Align(
                                        ...
                                        child: IconButton(
                                          ...
                                          tooltip: 'Delete',
                                          onPressed: () async {
                                            final String SlotId =  ("${data[index]["HostelSlotId"]}").toString();
                                            debugPrint('Check Inserted HostelSlotId : $SlotId');
            ...
            if(_dataLenght == "0")
              Column(
                ...
                children: <Widget>[
                  SizedBox(height: 25,),
                  Center(
                    child: Text("No Booking for Hostel",textAlign: TextAlign.center, style: TextStyle(fontSize: 19, color: Colors.black,fontFamily: "Camphor",
