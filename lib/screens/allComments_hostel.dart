...
import 'package:vetplanet/screens/hostelDetails.dart';
...
class AllCommentsHostelPage extends StatefulWidget {
  final String userKey;
  final String visitorCount;

  AllCommentsHostelPage({ this.userKey, this.visitorCount});

  @override
  _AllCommentsHostelPageState createState() => _AllCommentsHostelPageState();
}

class _AllCommentsHostelPageState extends State<AllCommentsHostelPage> {
