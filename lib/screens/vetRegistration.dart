...
class VetRegistration extends StatefulWidget {
  @override
  _VetRegistrationState createState() => _VetRegistrationState();
}

class _VetRegistrationState extends State<VetRegistration> {
  ...
  Future<ResultModel> registerPet(String petName, String dob, String age, String species, String breed, String color, String gender, String photograph ) async{
    final String apiUrl = "http://sofistsolutions.in/VetPlanetAPPAPI/API/SavePet/SavePet";
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: _photograph == null
                                        ...
                                        child: Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text(_photograph, style: TextStyle(fontFamily: "Robotoslab",
                                            fontWeight: FontWeight.w500,),),
                                        )),
                                  ...
                                  Container(
                                      child: ElevatedButton.icon(
                                        ...
                                        label: FittedBox(
                                            fit:BoxFit.fitWidth,child: Text("Upload Photograph", style: TextStyle(fontFamily: "Robotoslab",
